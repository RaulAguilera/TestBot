    ...
    public class UserProfileDialog : ComponentDialog
    {
        ...
        private async Task<DialogTurnResult> SummaryStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            if ((bool)stepContext.Result)
            {
                ...
                var msg = $"I have your mode of transport as {(string)stepContext.Values["transport"]} and your name as {(string)stepContext.Values["name"]}.";
                if ((int)stepContext.Values["age"] != -1)
                {
                    msg += $" And age as {(int)stepContext.Values["age"]}.";
                }

    ...
    public class CustomPromptBot : ActivityHandler
    {
        ...
        protected override async Task OnMembersAddedAsync(IList<ChannelAccount> membersAdded, ITurnContext<IConversationUpdateActivity> turnContext, CancellationToken cancellationToken)
        {
            foreach (var member in membersAdded)
            {
                ...
                {
                    await turnContext.SendActivityAsync(MessageFactory.Text($"Welcome to cab scheduler!"), cancellationToken);
                }
            }
        }
        ...
        private static async Task FillOutUserProfileAsync(ConversationFlow flow, UserProfile profile, ITurnContext<IMessageActivity> turnContext)
        {
